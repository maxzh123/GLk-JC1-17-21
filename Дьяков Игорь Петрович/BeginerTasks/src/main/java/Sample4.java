...
public class Sample4 {//Сообщаем компилятору что Это класс и мы дали ему имя Sample4
    ...
    * */
    ...
    private static void processNumber(int i,int index){
        if (i%3==0)
            System.out.println("Значение масива № "+index+ " равняется "+i+" :делится на 3");//Достаем системный поток out и вызываем его метод println (напечатать и перевести строку). В качестве аргумента передаем то, что хотим напечатать.
      else
