...
public class Task35_37 {
    ...
    public static Seasons[] newSeasons=Arrays.copyOfRange(seasons, 1, seasons.length); // сделала ещё массив без сезона зима в високосном году
    ...
    public static void showNextSeason() { //task 36
    ...
    public static void showNumbersOfDaysInSeason() { //task37
        System.out.println("Введите число от 1 до 4");
        int nextSeason=scanner.nextInt();
        switch (nextSeason) {
            case 1:
