...
public class Task48 {
    ...
    static String path = "C:\\Users\\WorkBook\\GLk-JC1-17-21\\Григорович Вероника Викторовна\\HomeWork\\src\\main\\java\\Tasks46_51_Files\\sample48.txt";
    static String path1 = "C:\\Users\\WorkBook\\GLk-JC1-17-21\\Григорович Вероника Викторовна\\HomeWork\\src\\main\\java\\Tasks46_51_Files\\sample49.txt"; //сюда будем записывать найденные числа
        ...
        FileWriter fileWriter = new FileWriter(path1)) {
            while (bufferedReader.ready()) {
                ...
                while (matcher.find()) {
                    ...
                    sum=sum+i;
                    fileWriter.write(String.valueOf(i)+" "); // плюс дополнительно записала числа в отдельный файл
