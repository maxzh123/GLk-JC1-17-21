...
public  final  class ConfigScoring {
    ...
    protected static  String NAME_ENCYCLOPEDIA = "СловарьТест.txt";
    protected static  String NAME_TEXT_FILE="findWord.txt"; //имя файла куда будет записываться

    protected static double THRESHOLD_VALUE = 0.6; //пороговое значение для нахождения соответсвия слов( около 80% )
