...
* */
public class Sample4 {//Сообщаем компилятору что Это класс и мы дали ему имя Samples.Sample4
    ...
    private static void processNumber(int i, int index) {
        if (i%3 == 0) {
            System.out.println("Значение масива № " + index + " равняется " + i + " и это число делится на 3");
        } else {
            System.out.println("Значение масива № " + index + " равняется " + i + " и это число не делится на 3");
